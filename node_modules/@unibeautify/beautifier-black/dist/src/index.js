...
exports.beautifier = {
    ...
    badges: [
        {
            ...
            url: "https://travis-ci.com/Unibeautify/beautifier-black.svg?branch=master",
    ...
    beautify({ text, dependencies, filePath, projectPath, options, }) {
        const black = dependencies.get("Black");
